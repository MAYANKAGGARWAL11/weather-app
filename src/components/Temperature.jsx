...
function Temperature({ setCity, stats }) {
  ...
  return (
    <>
      <div className="flex align-middle justify-center text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out">
        <input
          type="text"
          className="bg-rose-400  rounded-lg border border-slate-200 text-slate-200 placeholder-slate-200 text-md focus:border-slate-400 block w-60 p-2 focus:outline-none"
